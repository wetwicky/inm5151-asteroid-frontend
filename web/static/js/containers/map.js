...
class Map extends Component {
                            ...
                            return(<svg
                                ...
                                enableBackground="new 0 0 512 512" >
                                    ...
                                    <text
                                        ...
                                        fillOpacity="0.4"
                                        textAnchor="middle">
                                        { asteroid.health } / { MAX_HEALTH_ASTEROID }
                                    </text>
                                </svg>
                            )
                        })
    ...
    checkCollisions = () => {
        ...
        let shipRect = this.getCollisionRects(map, [ship])[0]
        let rects = this.getCollisionRects(map, bullets)
        ...
        for (let rect of rects) {
            ...
            let collisions = []
            for (let i = collisionNodes.length; i--; collisions.unshift(collisionNodes[i]));
        ...
        let shipCollisionNodes = map.getIntersectionList(shipRect, map)

        // Convert NodeList to array
        let collisions = []
        for (let i = shipCollisionNodes.length; i--; collisions.unshift(shipCollisionNodes[i]));
